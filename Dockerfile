...
RUN dotnet publish "./src/DeploymentTest/DeploymentTest.csproj" -c Release --no-restore -o /app/publish -p:VersionPrefix=$RELEASE_VERSION
...
USER 1000
ENTRYPOINT ["dotnet", "DeploymentTest.dll"]